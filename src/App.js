...
var song3 = ["Today is gonna be the day that they're gonna throw it back to you", "🕶 Oasis", "https://www.youtube.com/watch?v=bx1Bh8ZvH84"];
...
var song7 = ["In this life in this life in this life", "🦁 Bob Marley - Coming in from the cold", "https://www.youtube.com/watch?v=g3Z4PX2JI_c"];

/* GENERATE */
function generate() {
  var values = [song1,song3,song2,song5,song4,song7,song6],
    ...
    return (
      <div className="App">
        ...
        <div class="container">
          ...
          <div className="name" id="singer">⚡️Pixies - Hey</div>
